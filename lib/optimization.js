...
function stoch_annealing_quantities_random_projections(design, its, cooling) {
	let temperature = 1.0;
	let iteration = 0;
	const initialObj = objective(design);
	const optDimensions = Objective.shortnames(
...
// module.exports.stochastic_annealing_quantities_random_projections = stochastic_annealing_quantities_random_projections;
